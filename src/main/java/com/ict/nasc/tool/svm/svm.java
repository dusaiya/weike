...
class Solver {
    ...
    void Solve(int l, QMatrix Q, double[] p_, byte[] y_, double[] alpha_, double Cp, double Cn,
        ...
        int iter = 0;
        int max_iter = Math
            .max(10000000, l > Integer.MAX_VALUE / 100 ? Integer.MAX_VALUE : 100 * l);
...
final class Solver_NU extends Solver {
    ...
    void Solve(int l, QMatrix Q, double[] p, byte[] y, double[] alpha, double Cp, double Cn,
               double eps, SolutionInfo si, int shrinking) {
        this.si = si;
...
public class svm {
    ...
    private static void solve_c_svc(svm_problem prob, svm_parameter param, double[] alpha,
    ...
    private static void solve_nu_svc(svm_problem prob, svm_parameter param, double[] alpha,
    ...
    private static void solve_nu_svr(svm_problem prob, svm_parameter param, double[] alpha,
                                     Solver.SolutionInfo si) {
        int l = prob.l;
        double C = param.C;
        double[] alpha2 = new double[2 * l];
    ...
    static decision_function svm_train_one(svm_problem prob, svm_parameter param, double Cp,
                                           double Cn) {
